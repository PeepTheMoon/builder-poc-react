...
if (sdk_1.Builder.isBrowser && globalReplaceNodes) {
    var customCodeQuerySelector_1 = isShopify
        ? '.builder-custom-code'
...
var CustomCodeComponent = /** @class */ (function (_super) {
    ...
    function CustomCodeComponent(props) {
        ...
        if (_this.replaceNodes && sdk_1.Builder.isBrowser && _this.firstLoad && _this.props.builderBlock) {
    ...
    Object.defineProperty(CustomCodeComponent.prototype, "code", {
        get: function () {
            if (sdk_1.Builder.isServer && this.props.scriptsClientOnly) {
    ...
    CustomCodeComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", __assign({ ref: function (ref) { return (_this.elementRef = ref); }, 
            ...
            className: 'builder-custom-code' + (this.props.replaceNodes ? ' replace-nodes' : '') }, (!this.replaceNodes &&
            !this.noReactRender && {
...
exports.CustomCode = with_builder_1.withBuilder(CustomCodeComponent, {
    name: 'Custom Code',
    static: true,
    inputs: [
        {
