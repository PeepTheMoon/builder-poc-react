...
var VideoComponent = /** @class */ (function (_super) {
    ...
    VideoComponent.prototype.updateVideo = function () {
        ...
        if (this.video) {
            ...
            attributes.forEach(function (attr) {
                var _a, _b;
                if (_this.props[attr]) {
                    (_a = _this.video) === null || _a === void 0 ? void 0 : _a.setAttribute(attr.toLowerCase(), 'true');
                }
                else {
                    (_b = _this.video) === null || _b === void 0 ? void 0 : _b.removeAttribute(attr.toLowerCase());
                }
            });
        }
    };
    ...
    VideoComponent.prototype.render = function () {
        ...
        return (core_1.jsx("div", { ref: function (ref) { return (_this.containerRef = ref); }, css: { position: 'relative' } },
            core_1.jsx("video", { key: this.props.video || 'no-src', poster: this.props.posterImage, ref: function (ref) { return (_this.video = ref); }, autoPlay: this.props.autoPlay, muted: this.props.muted, controls: this.props.controls, loop: this.props.loop, className: "builder-video", css: __assign({ width: '100%', height: '100%', objectFit: this.props.fit, objectPosition: this.props.position, 
                    ...
                    : null)) }, (!this.lazyLoad || this.state.load) && (core_1.jsx("source", { type: "video/mp4", src: this.props.video }))),
            aspectRatio ? (core_1.jsx("div", { css: {
                    width: '100%',
                    paddingTop: aspectRatio * 100 + '%',
                    pointerEvents: 'none',
                    fontSize: 0,
                } })) : null,
            children && (core_1.jsx("div", { css: {
                    display: 'flex',
...
exports.Video = sdk_1.Builder.registerComponent(with_children_1.withChildren(VideoComponent), {
    name: 'Video',
