...
function getShopifyImageUrl(src, size) {
    ...
    if (match) {
        ...
        var suffix = match[3];
        var useSize = size.match('x') ? size : size + "x";
...
function getSrcSet(url) {
    ...
    if (url.match(/builder\.io/)) {
        ...
        if (!isNaN(widthInSrc_1)) {
            srcUrl = srcUrl + " " + widthInSrc_1 + "w";
        }
        return sizes
            .filter(function (size) { return size !== widthInSrc_1; })
            .map(function (size) { return updateQueryParam(url, 'width', size) + " " + size + "w"; })
            .concat([srcUrl])
            .join(', ');
    }
    if (url.match(/cdn\.shopify\.com/)) {
        return sizes
            .map(function (size) { return [getShopifyImageUrl(url, size + "x" + size), size]; })
            .filter(function (_a) {
            var sizeUrl = _a[0];
            return !!sizeUrl;
        })
...
exports.getSizes = function (sizes, block) {
    ...
    if (sizes) {
        ...
        if ((_c = (_b = (_a = block.responsiveStyles) === null || _a === void 0 ? void 0 : _a.small) === null || _b === void 0 ? void 0 : _b.width) === null || _c === void 0 ? void 0 : _c.match(unitRegex)) {
            ...
            var widthAndQuery = mediaQuery + " " + block.responsiveStyles.small.width.replace('%', 'vw');
        ...
        if ((_f = (_e = (_d = block.responsiveStyles) === null || _d === void 0 ? void 0 : _d.medium) === null || _e === void 0 ? void 0 : _e.width) === null || _f === void 0 ? void 0 : _f.match(unitRegex)) {
            hasSmallOrMediumSize = true;
            var mediaQuery = '(max-width: 999px)';
            var widthAndQuery = mediaQuery + " " + block.responsiveStyles.medium.width.replace('%', 'vw');
            generatedSizes.push(widthAndQuery);
        }
...
var ImageComponent = /** @class */ (function (_super) {
    ...
    ImageComponent.prototype.componentDidMount = function () {
        ...
        if (this.props.lazy && sdk_1.Builder.isBrowser) {
            if (this.pictureRef && isElementInViewport(this.pictureRef)) {
                ...
                var listener_1 = throttle_1.throttle(function (event) {
                    if (_this.pictureRef) {
    ...
    ImageComponent.prototype.render = function () {
        var _this = this;
        var _a = this.props, aspectRatio = _a.aspectRatio, lazy = _a.lazy;
        var children = this.props.builderBlock && this.props.builderBlock.children;
        var srcset = this.props.srcset;
        var sizes = exports.getSizes(this.props.sizes, this.props.builderBlock);
        ...
        return (core_1.jsx(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) {
            var _a;
            var amp = value.ampMode;
            var Tag = amp ? 'amp-img' : 'img';
            var imageContents = (!lazy || _this.state.load || amp) && (core_1.jsx(Tag, __assign({}, (amp
                ? {
                    layout: 'responsive',
                ...
                : null), { alt: _this.props.altText, key: sdk_1.Builder.isEditing
                    ...
                    _a))), loading: "lazy", className: 'builder-image' + (_this.props.className ? ' ' + _this.props.className : ''), src: _this.image }, (!amp && {
            ...
            return (core_1.jsx(react_1.default.Fragment, null,
                amp ? (imageContents) : (core_1.jsx("picture", { ref: function (ref) { return (_this.pictureRef = ref); } },
                    srcset && srcset.match(/builder\.io/) && !_this.props.noWebp && (core_1.jsx("source", { srcSet: srcset.replace(/\?/g, '?format=webp&'), type: "image/webp" })),
                    imageContents)),
                aspectRatio && !amp ? (core_1.jsx("div", { className: "builder-image-sizer", css: {
                        width: '100%',
                ...
                core_1.jsx("div", { css: {
                        ...
                        width: '100%',
                        height: '100%',
                    } }, children.map(function (block, index) { return (core_1.jsx(builder_block_component_1.BuilderBlock, { key: block.id, block: block })); }))) : null));
        }));
    };
    return ImageComponent;
}(react_1.default.Component));
exports.Image = with_builder_1.withBuilder(ImageComponent, {
    name: 'Image',
    static: true,
