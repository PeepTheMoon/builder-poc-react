...
var BuilderContent = /** @class */ (function (_super) {
    ...
    function BuilderContent() {
            ...
            switch (message.type) {
                case 'builder.patchUpdates': {
                    ...
                    for (var _i = 0, patches_1 = patches; _i < patches_1.length; _i++) {
                        ...
                        apply_patch_with_mutation_1.applyPatchWithMinimalMutationChain(_this.state.data, patch);
                    }
                    _this.setState({
                    ...
                    if (_this.props.contentLoaded) {
                        _this.props.contentLoaded(_this.state.data.data, _this.state.data);
                    }
                    break;
                }
            }
        ...
        _this.onClick = function (reactEvent) {
            ...
            if (sdk_1.builder.autoTrack) {
                _this.builder.trackInteraction(content.id, _this.renderedVairantId, _this.clicked, event, {
                    content: content,
                });
            }
            if (!_this.clicked) {
    ...
    Object.defineProperty(BuilderContent.prototype, "renderedVairantId", {
        get: function () {
            var _a, _b;
            var id = this.props.isStatic
                ? this.builder.getCookie("builder.tests." + ((_a = this.data) === null || _a === void 0 ? void 0 : _a.id))
    ...
    Object.defineProperty(BuilderContent.prototype, "options", {
        get: function () {
            ...
            if (this.props.content && !((_a = options.initialContent) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    Object.defineProperty(BuilderContent.prototype, "data", {
        get: function () {
            ...
            return (((this.props.inline || !sdk_1.Builder.isBrowser || this.firstLoad) &&
    ...
    BuilderContent.prototype.componentDidMount = function () {
        ...
        if (!this.props.inline || sdk_1.Builder.isEditing) {
                                ...
                                var observer = (_this.intersectionObserver = new IntersectionObserver(function (entries, observer) {
                                    entries.forEach(function (entry) {
                                        ...
                                        if (entry.intersectionRatio > 0 && !_this.trackedImpression) {
                                            _this.builder.trackImpression(match.id, _this.renderedVairantId, undefined, {
                                                content: _this.data,
                                            }),
                                                { content: _this.data };
    ...
    BuilderContent.prototype.render = function () {
        ...
        if (!this.props.isStatic) {
            return (react_1.default.createElement(TagName, __assign({}, (!this.props.dataOnly && {
                ref: function (ref) { return (_this.ref = ref); },
            }), { className: "builder-content", onClick: this.onClick, "builder-content-id": useData === null || useData === void 0 ? void 0 : useData.id, "builder-model": this.name }), this.props.children(useData === null || useData === void 0 ? void 0 : useData.data, this.props.inline ? false : loading, useData)));
        }
