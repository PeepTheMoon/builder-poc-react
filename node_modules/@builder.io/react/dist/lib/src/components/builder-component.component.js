...
var safe_dynamic_require_1 = require("../functions/safe-dynamic-require");
...
var wrapComponent = function (info) {
    return function (props) {
        ...
        var baseProps = omit.apply(void 0, __spreadArrays([props], inputNames, ['attributes']));
...
function decorator(fn) {
    return function argReceiver() {
        ...
        function descriptorChecker(target, key, descriptor) {
            ...
            return __assign(__assign({}, descriptor), (_a = {}, _a[descriptorKey] = fn.apply(void 0, __spreadArrays([descriptor[descriptorKey]], fnArgs)), _a));
        }
    };
}
var Throttle = decorator(throttle_1.throttle);
var fetchCache = {};
var tryEval = function (str, data, errors) {
    ...
    try {
        if (sdk_1.Builder.isBrowser) {
            ...
            var VM = safe_dynamic_require_1.safeDynamicRequire('vm2').VM;
            return new VM({
...
var BuilderComponent = /** @class */ (function (_super) {
    ...
    function BuilderComponent(props) {
        ...
        _this.styleRef = null;
        _this.rootState = sdk_1.Builder.isServer ? {} : on_change_1.default({}, function () { return _this.updateState(); });
        _this.lastJsCode = '';
        ...
        _this.resizeListener = sdk_1.Builder.isEditing ? throttle_1.throttle(_this.resizeFn, 200) : debounce(_this.resizeFn, 400);
        _this.mounted = false;
                        ...
                        if (url && (!_this.data[key] || sdk_1.Builder.isEditing)) {
                            ...
                            if (sdk_1.Builder.isBrowser) {
                                ...
                                if (false && sdk_1.Builder.isEditing && model && _this.builder.editingModel === model) {
                                    _this.throttledHandleRequest(key, finalUrl_1);
                                    // TODO: fix this
                                    ...
                                    // TODO: fix this
                                    var newSubscription = (_this.httpSubscriptionPerKey[key] = _this.onStateChange.subscribe(function () {
        ...
        if (sdk_1.Builder.isBrowser) {
            ...
            if (_this.inlinedContent) {
                ...
                _this.onContentLoaded(content === null || content === void 0 ? void 0 : content.data, content);
            }
        }
        return _this;
    }
    ...
    BuilderComponent.prototype.getHtmlData = function () {
        ...
        var script = id &&
            ...
            document.querySelector("script[data-builder-json=\"" + id + "\"],script[data-builder-state=\"" + id + "\"]");
        if (script) {
            try {
    ...
    Object.defineProperty(BuilderComponent.prototype, "isPreviewing", {
        get: function () {
            return ((sdk_1.Builder.isServer || (sdk_1.Builder.isBrowser && sdk_1.Builder.isPreviewing)) &&
    ...
    BuilderComponent.prototype.render = function () {
        ...
        var dataString = sdk_1.Builder.isBrowser && this.props.data && size(this.props.data) && hash_sum_1.default(this.props.data);
        ...
        react_1.default.createElement(WrapComponent, { onClick: function (event) {
            ...
            }, className: "builder-component " + (contentId ? "builder-component-" + contentId : ''), "data-name": this.name, "data-source": "Rendered by Builder.io", key: this.state.key, ref: function (ref) { return (_this.ref = ref); } },
                        ...
                        if (codegen && !_this.Component && (data === null || data === void 0 ? void 0 : data.blocksJs)) {
                            ...
                            var useBuilderState = function (initialState) {
                                ...
                                var state = react_1.default.useState(function () {
                                    return on_change_1.default(initialState, function () {
                            ...
                            _this.Component = new (Function.bind.apply(Function, __spreadArrays([void 0, 'jsx',
                                '_css',
                                'Builder',
                                'builder',
                                'React',
                                'useBuilderState'], mappedComponentNames, [data.blocksJs])))().apply(void 0, __spreadArrays([core_1.jsx,
                                core_1.css,
                                sdk_1.Builder,
                                sdk_1.builder,
                                react_1.default,
                                useBuilderState], finalizedComponents));
                        }
    ...
    BuilderComponent.prototype.throttledHandleRequest = function (propertyName, url) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                existing = this._asyncRequests &&
                    this._asyncRequests.find(function (req) { return builder_async_requests_1.isRequestInfo(req) && req.url === url; });
                if (existing) {
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], BuilderComponent.prototype, "throttledHandleRequest", null);
